...
<div class="container mt-5">
   ...
   <?php $no=1; ?>
   <div class="row mt-3">
    <form class="inline" action="<?php echo e(base_url('category/search')); ?>">
      <div class="input-group mb-3">
        
        <input type="text" value="<?php echo e((empty($_GET['np'])) ? '' : $_GET['np']); ?>" class="form-control" name="np" placeholder="Nama Kategori" aria-label="nama Produk" aria-describedby="button-addon2">
